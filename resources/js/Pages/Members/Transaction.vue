...
const openInNewTab = (id) => {
    // Open in a new tab
    window.open('/member/invoice/' + id, '_blank');
}
            ...
            <div class="flex flex-col relative items-center justify-center">
                ...
                <div class="w-full h-screen bg-welcome bg-no-repeat bg-center bg-cover flex flex-col content-center">
                    <div class="mx-auto mt-10 flex flex-row w-3/4  bg-white rounded p-7">
                        <div @click="openInNewTab(12)" class="bg-red z-50 mx-4 text-center justify-center flex flex-row gap-1 items-center uppercase">
                            <i data-feather="user"></i><span>Invoice</span>
                        </div>
                    </div>
                </div>
            </div>
